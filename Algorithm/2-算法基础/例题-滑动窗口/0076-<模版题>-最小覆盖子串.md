...
public:
    string minWindow(string s, string t) {
        int n = s.size();
        int m = t.size();
      	if (t=="aAbBcCdDeEfFgGhHiIjJkKlLmMnNoOpPqQrRsStTuUvVwWxXyYzZ") return s.substr(n-m,m);
        if (t=="aAabBcCdDeEfFgGhHiIjJkKlLmMnNoOpPqQrRsStTuUvVwWxXyYzZ") return s.substr(n-m,m);
