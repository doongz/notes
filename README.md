...
- [C](https://dowalle.gitbook.io/algo/skill/c)
  - [基础知识](https://dowalle.gitbook.io/algo/skill/c/1-ji-chu-zhi-shi)  `数据类型`  `输入和输出`  `条件控制和循环`  `数组`  `函数`  `预处理`  `指针`  `结构体`  `文件操作`  `头文件`
...
- [Golang](https://dowalle.gitbook.io/algo/skill/golang)
  ...
  - [Go语言并发](https://dowalle.gitbook.io/algo/skill/golang/2go-yu-yan-bing-fa)  `goroutine`  `chan`  `WaitGroup`  `如何实现`  `sync.Mutex`  `sync.RWMutex`  `atomic`  `死锁`
...
- [操作系统](https://dowalle.gitbook.io/algo/knowledge/2-cao-zuo-xi-tong)
  ...
  - [虚拟化](https://dowalle.gitbook.io/algo/knowledge/2-cao-zuo-xi-tong/6-xu-ni-hua)
