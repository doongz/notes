...
### 4、Baker's Real-Time Copying Garbage Collector
...
简化了GC的并发。GC现在可以遍历未被扫描的内存Page，并且一次扫描一个Page
...
![](./doc/image%20%28756%29%20%281%29.png)
