...
当一个操作系统收到了一个packet，软件会解析每个header，做校验，剥离header，并得到下一个header。一直重复这个过程直到得到最后的数据。这就是嵌套的packet header。
...
![](./doc/image%20%28403%29%20%281%29%20%281%29.png)
...
![](./doc/image%20%28386%29%20%281%29%20%281%29%20%281%29.png)
