# [RCU notes](https://pdos.csail.mit.edu/6.828/2020/lec/l-rcu.txt)
...
需要等待最后一个数据读取者读完旧的E2，然后才能释放旧的E2
