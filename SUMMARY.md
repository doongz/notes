...
- Algorithm
  ...
  - 1-数据结构
    ...
    - 例题-二叉搜索树
      * [98-[中序递归]-验证二叉搜索树](Algorithm/1-数据结构/例题-二叉搜索树/98-[中序递归]-验证二叉搜索树.md)
    ...
    - 设计数据结构
      ...
      * [剑指Offer-II-030-插入删除和随机访问都是O(1)的容器](Algorithm/1-数据结构/设计数据结构/剑指Offer-II-030-插入删除和随机访问都是O(1)的容器.md)
      * [面试题-03-01-一个数组实现三个栈](Algorithm/1-数据结构/设计数据结构/面试题-03-01-一个数组实现三个栈.md)
      * [面试题-03-04-化栈为队](Algorithm/1-数据结构/设计数据结构/面试题-03-04-化栈为队.md)
  ...
  - 2-算法基础
    ...
    - 例题-二分法
      ...
      * [剑指Offer-53-II-0～n-1中缺失的数字](Algorithm/2-算法基础/例题-二分法/剑指Offer-53-II-0～n-1中缺失的数字.md)
    - 例题-分治
    ...
    - 例题-前缀和
      ...
      * [剑指Offer-II-011-[前缀和+哈希表]-0和1个数相同的子数组](Algorithm/2-算法基础/例题-前缀和/剑指Offer-II-011-[前缀和+哈希表]-0和1个数相同的子数组.md)
    ...
    - 例题-位运算
      ...
      * [2429-[贪心]-最小XOR](Algorithm/2-算法基础/例题-位运算/2429-[贪心]-最小XOR.md)
  ...
  - 3-动态规划
    ...
    - 例题-线性DP
      ...
      * [剑指Offer-47-[路径问题]-礼物的最大价值](Algorithm/3-动态规划/例题-线性DP/剑指Offer-47-[路径问题]-礼物的最大价值.md)
    ...
    * [空间压缩的方式](Algorithm/3-动态规划/空间压缩的方式.md)
  - 4-图论
    - 例题-欧拉图
  ...
  - 5-数学
    - 常用算法
      ...
      * [08-最大公约数&最小公倍数](Algorithm/5-数学/常用算法/08-最大公约数&最小公倍数.md)
      * [09-中位数](Algorithm/5-数学/常用算法/09-中位数.md)
    - 经典算法
    ...
    - 例题-常用算法
      * [12-[找零问题]-整数转罗马数字](Algorithm/5-数学/例题-常用算法/12-[找零问题]-整数转罗马数字.md)
      * [1266-访问所有点的最小时间](Algorithm/5-数学/例题-常用算法/1266-访问所有点的最小时间.md)
      * [13-[找零问题]-整数转罗马数字](Algorithm/5-数学/例题-常用算法/13-[找零问题]-整数转罗马数字.md)
      ...
      * [2091-[数学]-从数组中移除最大值和最小值](Algorithm/5-数学/例题-常用算法/2091-[数学]-从数组中移除最大值和最小值.md)
      ...
      * [2447-最大公因数等于K的子数组数目](Algorithm/5-数学/例题-常用算法/2447-最大公因数等于K的子数组数目.md)
      * [2448-[中位数]-使数组相等的最小开销](Algorithm/5-数学/例题-常用算法/2448-[中位数]-使数组相等的最小开销.md)
      * [2457-[进位]-美丽整数的最小增量](Algorithm/5-数学/例题-常用算法/2457-[进位]-美丽整数的最小增量.md)
      * [2470-[最小公倍数]-最小公倍数为K的子数组数目](Algorithm/5-数学/例题-常用算法/2470-[最小公倍数]-最小公倍数为K的子数组数目.md)
      ...
      * [462-[中位数]-最小操作次数使数组元素相等II](Algorithm/5-数学/例题-常用算法/462-[中位数]-最小操作次数使数组元素相等II.md)
      ...
      * [7-[整数反转]-整数反转](Algorithm/5-数学/例题-常用算法/7-[整数反转]-整数反转.md)
      * [70-[动规&快速幂&通项式]-爬楼梯](Algorithm/5-数学/例题-常用算法/70-[动规&快速幂&通项式]-爬楼梯.md)
      * [781-[数学推理]-森林中的兔子](Algorithm/5-数学/例题-常用算法/781-[数学推理]-森林中的兔子.md)
      * [9-[整数反转]-回文数](Algorithm/5-数学/例题-常用算法/9-[整数反转]-回文数.md)
    - 例题-经典算法
      * [169-[投票算法]-多数元素](Algorithm/5-数学/例题-经典算法/169-[投票算法]-多数元素.md)
      * [382-[蓄水池抽样]-链表随机节点](Algorithm/5-数学/例题-经典算法/382-[蓄水池抽样]-链表随机节点.md)
      * [384-[洗牌算法]-打乱数组](Algorithm/5-数学/例题-经典算法/384-[洗牌算法]-打乱数组.md)
      * [390-[约瑟夫环]-消除游戏](Algorithm/5-数学/例题-经典算法/390-[约瑟夫环]-消除游戏.md)
      * [剑指Offer-16-[快速幂]-数值的整数次方](Algorithm/5-数学/例题-经典算法/剑指Offer-16-[快速幂]-数值的整数次方.md)
      * [剑指Offer-39-[投票算法]-数组中出现次数超过一半的数字](Algorithm/5-数学/例题-经典算法/剑指Offer-39-[投票算法]-数组中出现次数超过一半的数字.md)
      * [剑指Offer-62-[约瑟夫环]-圆圈中最后剩下的数字](Algorithm/5-数学/例题-经典算法/剑指Offer-62-[约瑟夫环]-圆圈中最后剩下的数字.md)
  ...
  - 6-系列题目
    - [01-括号问题](Algorithm/6-系列题目/01-括号问题/README.md)
    ...
    - 02-组合问题
      ...
      * [剑指Offer-38-字符串的排列](Algorithm/6-系列题目/02-组合问题/剑指Offer-38-字符串的排列.md)
    - 03-算术问题
      * [剑指Offer-65-不用加减乘除做加法](Algorithm/6-系列题目/03-算术问题/剑指Offer-65-不用加减乘除做加法.md)
      * [剑指Offer-II-001-整数除法](Algorithm/6-系列题目/03-算术问题/剑指Offer-II-001-整数除法.md)
      * [剑指Offer-II-002-二进制加法](Algorithm/6-系列题目/03-算术问题/剑指Offer-II-002-二进制加法.md)
    - 04-回文问题
      * [2472-[中心扩散+贪心]-不重叠回文子字符串的最大数目](Algorithm/6-系列题目/04-回文问题/2472-[中心扩散+贪心]-不重叠回文子字符串的最大数目.md)
      * [剑指Offer-II-018-[左右双指针]-有效的回文](Algorithm/6-系列题目/04-回文问题/剑指Offer-II-018-[左右双指针]-有效的回文.md)
      * [剑指Offer-II-019-[左右双指针]-最多删除一个字符得到回文](Algorithm/6-系列题目/04-回文问题/剑指Offer-II-019-[左右双指针]-最多删除一个字符得到回文.md)
      * [剑指Offer-II-020-[双指针+中心扩散]-回文子字符串的个数](Algorithm/6-系列题目/04-回文问题/剑指Offer-II-020-[双指针+中心扩散]-回文子字符串的个数.md)
    - [05-子数组问题](Algorithm/6-系列题目/05-子数组问题/README.md)
      * [2444-[子数组计数]-统计定界子数组的数目](Algorithm/6-系列题目/05-子数组问题/2444-[子数组计数]-统计定界子数组的数目.md)
      * [剑指Offer-II-009-[子数组计数]-乘积小于 K 的子数组](Algorithm/6-系列题目/05-子数组问题/剑指Offer-II-009-[子数组计数]-乘积小于%20K 的子数组.md)
    - [06-树的路径问题](Algorithm/6-系列题目/06-树的路径问题/README.md)
      * [112-[记录路径值]-路径总和](Algorithm/6-系列题目/06-树的路径问题/112-[记录路径值]-路径总和.md)
      * [113-[记录路径]-路径总和II](Algorithm/6-系列题目/06-树的路径问题/113-[记录路径]-路径总和II.md)
      * [124-[任意节点到任意节点]-二叉树中的最大路径和](Algorithm/6-系列题目/06-树的路径问题/124-[任意节点到任意节点]-二叉树中的最大路径和.md)
      * [257-[所有路径]-二叉树的所有路径](Algorithm/6-系列题目/06-树的路径问题/257-[所有路径]-二叉树的所有路径.md)
      * [437-[前缀和]-路径总和III](Algorithm/6-系列题目/06-树的路径问题/437-[前缀和]-路径总和III.md)
      * [543-[任意节点到任意节点]-二叉树的直径](Algorithm/6-系列题目/06-树的路径问题/543-[任意节点到任意节点]-二叉树的直径.md)
      * [687-[任意节点到任意节点]-最长同值路径](Algorithm/6-系列题目/06-树的路径问题/687-[任意节点到任意节点]-最长同值路径.md)
      * [988-[所有路径]-从叶结点开始的最小字符串](Algorithm/6-系列题目/06-树的路径问题/988-[所有路径]-从叶结点开始的最小字符串.md)
      * [面试题-04-12-求和路径](Algorithm/6-系列题目/06-树的路径问题/面试题-04-12-求和路径.md)
    - 接雨水
...
- Knowledge
  ...
  - 07-AI
    ...
    * [03-模拟退火](Knowledge/07-AI/03-模拟退火.md)
- Math
  - 微积分
