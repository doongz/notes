...
- Algorithm
  ...
  - 1-数据结构
    ...
    - 设计数据结构
      ...
      * [2502-设计内存分配器](Algorithm/1-数据结构/设计数据结构/2502-设计内存分配器.md)
  ...
  - 5-数学
    - 1-数学运算
      ...
      * [02-进制转换](Algorithm/5-数学/1-数学运算/02-进制转换.md)
    ...
    - 例题-矩阵运算
      ...
      * [70-[矩阵快速幂模版题]-爬楼梯](Algorithm/5-数学/例题-矩阵运算/70-[矩阵快速幂模版题]-爬楼梯.md)
      * [剑指Offer-10-[矩阵快速幂模版题]-斐波那契数列](Algorithm/5-数学/例题-矩阵运算/剑指Offer-10-[矩阵快速幂模版题]-斐波那契数列.md)
    - 例题-数学运算
      * [12-[找零问题]-整数转罗马数字](Algorithm/5-数学/例题-数学运算/12-[找零问题]-整数转罗马数字.md)
      * [1266-访问所有点的最小时间](Algorithm/5-数学/例题-数学运算/1266-访问所有点的最小时间.md)
      * [13-[找零问题]-整数转罗马数字](Algorithm/5-数学/例题-数学运算/13-[找零问题]-整数转罗马数字.md)
      * [168-171-[进制转化]-Excel表列名称序号转换](Algorithm/5-数学/例题-数学运算/168-171-[进制转化]-Excel表列名称序号转换.md)
      * [189-[环状替换]-轮转数组](Algorithm/5-数学/例题-数学运算/189-[环状替换]-轮转数组.md)
      * [2091-[数学]-从数组中移除最大值和最小值](Algorithm/5-数学/例题-数学运算/2091-[数学]-从数组中移除最大值和最小值.md)
      * [2110-[数学]-股票平滑下跌阶段的数目](Algorithm/5-数学/例题-数学运算/2110-[数学]-股票平滑下跌阶段的数目.md)
      * [2156-[不会-模运算-反向滑动窗口]-查找给定哈希值的子串](Algorithm/5-数学/例题-数学运算/2156-[不会-模运算-反向滑动窗口]-查找给定哈希值的子串.md)
      * [2169-[辗转相除]-得到0的操作数](Algorithm/5-数学/例题-数学运算/2169-[辗转相除]-得到0的操作数.md)
      * [2310-[同余性质]-个位数字为K的整数之和](Algorithm/5-数学/例题-数学运算/2310-[同余性质]-个位数字为K的整数之和.md)
      * [2447-最大公因数等于K的子数组数目](Algorithm/5-数学/例题-数学运算/2447-最大公因数等于K的子数组数目.md)
      * [2448-[中位数]-使数组相等的最小开销](Algorithm/5-数学/例题-数学运算/2448-[中位数]-使数组相等的最小开销.md)
      * [2457-[进位]-美丽整数的最小增量](Algorithm/5-数学/例题-数学运算/2457-[进位]-美丽整数的最小增量.md)
      * [2470-[最小公倍数]-最小公倍数为K的子数组数目](Algorithm/5-数学/例题-数学运算/2470-[最小公倍数]-最小公倍数为K的子数组数目.md)
      * [268-[高斯求和]-丢失的数字](Algorithm/5-数学/例题-数学运算/268-[高斯求和]-丢失的数字.md)
      * [29-[倍增]-两数相除](Algorithm/5-数学/例题-数学运算/29-[倍增]-两数相除.md)
      * [31-下一个排列](Algorithm/5-数学/例题-数学运算/31-下一个排列.md)
      * [415-43-67-[模拟]-字符串相加相乘](Algorithm/5-数学/例题-数学运算/415-43-67-[模拟]-字符串相加相乘.md)
      * [462-[中位数]-最小操作次数使数组元素相等II](Algorithm/5-数学/例题-数学运算/462-[中位数]-最小操作次数使数组元素相等II.md)
      * [50-[快速幂]-Pow(x, n)](Algorithm/5-数学/例题-数学运算/50-[快速幂]-Pow(x,%20n).md)
      * [523-[同余性质&前缀和]-连续的子数组和](Algorithm/5-数学/例题-数学运算/523-[同余性质&前缀和]-连续的子数组和.md)
      * [66-[进位]-加一](Algorithm/5-数学/例题-数学运算/66-[进位]-加一.md)
      * [69-[二分&牛顿迭代]-Sqrt(x)](Algorithm/5-数学/例题-数学运算/69-[二分&牛顿迭代]-Sqrt(x).md)
      * [7-[整数反转]-整数反转](Algorithm/5-数学/例题-数学运算/7-[整数反转]-整数反转.md)
      * [70-[动规&快速幂&通项式]-爬楼梯](Algorithm/5-数学/例题-数学运算/70-[动规&快速幂&通项式]-爬楼梯.md)
      * [781-[数学推理]-森林中的兔子](Algorithm/5-数学/例题-数学运算/781-[数学推理]-森林中的兔子.md)
      * [9-[整数反转]-回文数](Algorithm/5-数学/例题-数学运算/9-[整数反转]-回文数.md)
      * [剑指Offer-16-[快速幂]-数值的整数次方](Algorithm/5-数学/例题-数学运算/剑指Offer-16-[快速幂]-数值的整数次方.md)
  - 6-系列题目
