...
- Skill
  ...
  - C
    ...
    - C语言内存
      * [01-程序在计算机中如何运行](Skill/C/C语言内存/01-程序在计算机中如何运行.md)
      * [02-虚拟内存](Skill/C/C语言内存/02-虚拟内存.md)
      * [03-虚拟地址空间及编译模式](Skill/C/C语言内存/03-虚拟地址空间及编译模式.md)
      * [04-内存对齐-提高寻址效率](Skill/C/C语言内存/04-内存对齐-提高寻址效率.md)
      * [05-内存分页机制-提高内存使用效率](Skill/C/C语言内存/05-内存分页机制-提高内存使用效率.md)
      * [06-MMU部件及对内存权限的控制](Skill/C/C语言内存/06-MMU部件及对内存权限的控制.md)
      * [07-内存模型](Skill/C/C语言内存/07-内存模型.md)
      * [08-用户模式和内核模式](Skill/C/C语言内存/08-用户模式和内核模式.md)
      * [09-栈-函数调用](Skill/C/C语言内存/09-栈-函数调用.md)
      * [10-堆-动态内存分配](Skill/C/C语言内存/10-堆-动态内存分配.md)
      * [11-内存池](Skill/C/C语言内存/11-内存池.md)
      * [12-野指针及非法内存操作](Skill/C/C语言内存/12-野指针及非法内存操作.md)
      * [13-内存泄露](Skill/C/C语言内存/13-内存泄露.md)
      * [14-C语言变量的存储类别和生存期](Skill/C/C语言内存/14-C语言变量的存储类别和生存期.md)
      * [堆和栈的解释和区别](Skill/C/C语言内存/堆和栈的解释和区别.md)
  - C++
    - 1-基础知识
