...
- Algorithm
  ...
  - 1-数据结构
    ...
    - 例题-二叉树
      ...
      * [剑指Offer-33-二叉搜索树的后序遍历序列](Algorithm/1-数据结构/例题-二叉树/剑指Offer-33-二叉搜索树的后序遍历序列.md)
    - 例题-哈希表
    ...
    - 设计数据结构
      ...
      * [剑指Offer-09-用两个栈实现队列](Algorithm/1-数据结构/设计数据结构/剑指Offer-09-用两个栈实现队列.md)
  ...
  - 5-数学
    - 常用算法
      * [01-num和arr互转](Algorithm/5-数学/常用算法/01-num和arr互转.md)
      * [02-进制转换](Algorithm/5-数学/常用算法/02-进制转换.md)
      * [03-向上取整](Algorithm/5-数学/常用算法/03-向上取整.md)
      * [04-余数相关性质](Algorithm/5-数学/常用算法/04-余数相关性质.md)
      * [05-高斯求和](Algorithm/5-数学/常用算法/05-高斯求和.md)
      * [06-快速幂](Algorithm/5-数学/常用算法/06-快速幂.md)
      * [07-矩阵运算](Algorithm/5-数学/常用算法/07-矩阵运算.md)
    - 经典算法
      * [01-蓄水池抽样算法-随机算法](Algorithm/5-数学/经典算法/01-蓄水池抽样算法-随机算法.md)
      * [02-洗牌算法-生成随机数组](Algorithm/5-数学/经典算法/02-洗牌算法-生成随机数组.md)
      * [03-约瑟夫环](Algorithm/5-数学/经典算法/03-约瑟夫环.md)
      * [04-投票算法-找一半以上元素](Algorithm/5-数学/经典算法/04-投票算法-找一半以上元素.md)
    - 例题-常用算法
      * [12-13-[找零问题]-整数和罗马数字互转](Algorithm/5-数学/例题-常用算法/12-13-[找零问题]-整数和罗马数字互转.md)
      * [1266-访问所有点的最小时间](Algorithm/5-数学/例题-常用算法/1266-访问所有点的最小时间.md)
      * [168-171-[进制转化]-Excel表列名称序号转换](Algorithm/5-数学/例题-常用算法/168-171-[进制转化]-Excel表列名称序号转换.md)
      * [189-[环状替换]-轮转数组](Algorithm/5-数学/例题-常用算法/189-[环状替换]-轮转数组.md)
      * [2110-[数学]-股票平滑下跌阶段的数目](Algorithm/5-数学/例题-常用算法/2110-[数学]-股票平滑下跌阶段的数目.md)
      * [2156-[不会-模运算-反向滑动窗口]-查找给定哈希值的子串](Algorithm/5-数学/例题-常用算法/2156-[不会-模运算-反向滑动窗口]-查找给定哈希值的子串.md)
      * [2169-[辗转相除]-得到0的操作数](Algorithm/5-数学/例题-常用算法/2169-[辗转相除]-得到0的操作数.md)
      * [2310-[同余性质]-个位数字为K的整数之和](Algorithm/5-数学/例题-常用算法/2310-[同余性质]-个位数字为K的整数之和.md)
      * [268-[高斯求和]-丢失的数字](Algorithm/5-数学/例题-常用算法/268-[高斯求和]-丢失的数字.md)
      * [29-[倍增]-两数相除](Algorithm/5-数学/例题-常用算法/29-[倍增]-两数相除.md)
      * [31-下一个排列](Algorithm/5-数学/例题-常用算法/31-下一个排列.md)
      * [390-[数学]-消除游戏](Algorithm/5-数学/例题-常用算法/390-[数学]-消除游戏.md)
      * [415-43-67-[模拟]-字符串相加相乘](Algorithm/5-数学/例题-常用算法/415-43-67-[模拟]-字符串相加相乘.md)
      * [50-[快速幂]-Pow(x, n)](Algorithm/5-数学/例题-常用算法/50-[快速幂]-Pow(x,%20n).md)
      * [523-[同余性质&前缀和]-连续的子数组和](Algorithm/5-数学/例题-常用算法/523-[同余性质&前缀和]-连续的子数组和.md)
      * [5940-[数学]-从数组中移除最大值和最小值](Algorithm/5-数学/例题-常用算法/5940-[数学]-从数组中移除最大值和最小值.md)
      * [66-[进位]-加一](Algorithm/5-数学/例题-常用算法/66-[进位]-加一.md)
      * [69-[二分&牛顿迭代]-Sqrt(x)](Algorithm/5-数学/例题-常用算法/69-[二分&牛顿迭代]-Sqrt(x).md)
      * [7-9-[整数反转]-整数反转-回文数](Algorithm/5-数学/例题-常用算法/7-9-[整数反转]-整数反转-回文数.md)
      * [70-[动规&快速幂&通项式]-爬楼梯](Algorithm/5-数学/例题-常用算法/70-[动规&快速幂&通项式]-爬楼梯.md)
      * [781-[数学推理]-森林中的兔子](Algorithm/5-数学/例题-常用算法/781-[数学推理]-森林中的兔子.md)
    - 例题-经典算法
      * [382-[蓄水池抽样]-链表随机节点](Algorithm/5-数学/例题-经典算法/382-[蓄水池抽样]-链表随机节点.md)
      * [384-[洗牌算法]-打乱数组](Algorithm/5-数学/例题-经典算法/384-[洗牌算法]-打乱数组.md)
      * [剑指Offer-16-[快速幂]-数值的整数次方](Algorithm/5-数学/例题-经典算法/剑指Offer-16-[快速幂]-数值的整数次方.md)
      * [面试题-17-10-[投票算法]-主要元素](Algorithm/5-数学/例题-经典算法/面试题-17-10-[投票算法]-主要元素.md)
    - 例题-矩阵快速幂
      ...
      * [70-[模版题]-爬楼梯](Algorithm/5-数学/例题-矩阵快速幂/70-[模版题]-爬楼梯.md)
      * [剑指Offer-10-[模版题]-斐波那契数列](Algorithm/5-数学/例题-矩阵快速幂/剑指Offer-10-[模版题]-斐波那契数列.md)
    - 例题-快速幂
      * [剑指Offer-16-数值的整数次方](Algorithm/5-数学/例题-快速幂/剑指Offer-16-数值的整数次方.md)
  - 6-系列题目
    - 01-括号问题
    ...
    - 02-组合问题
      ...
      * [377-[记忆化dfs-dp]-组合总和Ⅳ](Algorithm/6-系列题目/02-组合问题/377-[记忆化dfs-dp]-组合总和Ⅳ.md)
      ...
      * [剑指Offer-17-打印从1到最大的n位数](Algorithm/6-系列题目/02-组合问题/剑指Offer-17-打印从1到最大的n位数.md)
    - 接雨水
