...
- Algorithm
  ...
  - 1-数据结构
    ...
    - 例题-平衡数
      * [110-平衡二叉树](Algorithm/1-数据结构/例题-平衡数/110-平衡二叉树.md)
      * [2349-[平衡数-懒删除堆]-设计数字容器系统](Algorithm/1-数据结构/例题-平衡数/2349-[平衡数-懒删除堆]-设计数字容器系统.md)
      * [98-验证二叉搜索树](Algorithm/1-数据结构/例题-平衡数/98-验证二叉搜索树.md)
    - 例题-树状数组
    ...
    * [补充-自定义排序的数据结构](Algorithm/1-数据结构/补充-自定义排序的数据结构.md)
  - 2-算法基础
    - 例题-二分法
