...
- Algorithm
  ...
  - 2-算法基础
    ...
    - 例题-滑动窗口
      * [1423-[反方向滑动窗口-前后缀和]-可获得的最大点数](Algorithm/2-算法基础/例题-滑动窗口/1423-[反方向滑动窗口-前后缀和]-可获得的最大点数.md)
      ...
      * [5939-[滑动窗口]-半径为k的子数组平均值](Algorithm/2-算法基础/例题-滑动窗口/5939-[滑动窗口]-半径为k的子数组平均值.md)
